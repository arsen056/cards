...
import {ForgotActionType} from "../features/Auth/forgot-password/forgotReducer";
...
export type ActionsRootTypes = ProfileActionsType | AppActionsType | SignUpActionsType | SignInACType | ForgotActionType
...
export const PackModal = ({packModalFunctional, typeButton, titleButton, nameValue}: Props) => {
	...
	return (
		<div>
			<BasicModal titleButton={titleButton} open={open} handleOpen={handleOpen} handleClose={handleClose} typeButton={typeButton}>
				<div>
					...
					<Box
						...
						autoComplete="off"
					>
						<TextField id="standard-basic" label="Name pack" variant="standard" onChange={onChangeHandler} style={{marginBottom: 30}} value={value ? value : nameValue}/>
					</Box>

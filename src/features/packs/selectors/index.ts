...
export const selectMin = (state: AppRootStateType):number | undefined => state.packs.searchParams.min
export const selectMax = (state: AppRootStateType):number | undefined => state.packs.searchParams.max

...
export const selectCardPacksTotaCount = (state: AppRootStateType): number =>
...
export const selectIsMyPacks = (state: AppRootStateType): boolean =>
  state.packs.searchParams.isMyPacks
export const searchParamsSelector = (state: AppRootStateType) => state.packs.searchParams.packName
export const selectPackName = (state: AppRootStateType): string | null =>
  state.packs.searchParams.packName
export const selectPage = (state: AppRootStateType): number => state.packs.searchParams.page
export const selectPageCount = (state: AppRootStateType): number =>
